...
screenshots:
  ...
  - image: "../../assets/projects/ssuai-chat-graduation-requirements.png"
    alt: "ssuAI 챗봇이 연결된 학사 데이터를 조회해 남은 졸업요건을 정리한 화면"
    caption: "ssuAI 챗봇 — 인증된 학사 데이터를 조회하고 도구 진행 상태를 스트리밍해 남은 졸업요건을 정리한 실제 세션입니다."
  - image: "../../assets/projects/ssuai-chat-seat-approval.png"
    alt: "ssuAI 챗봇이 도서관 좌석 후보를 준비하고 실행 전 사용자 승인을 요청하는 화면"
    caption: "ssuAI 챗봇 — 도서관 에이전트가 좌석 후보를 준비한 뒤 HITL 카드에서 멈춰 사용자 승인을 기다립니다."
  - image: "../../assets/projects/ssuai-chat-seat-reserved.png"
    alt: "사용자 승인 후 ssuAI 챗봇이 도서관 좌석 예약을 완료하고 상태를 확인한 화면"
    caption: "ssuAI 챗봇 — 명시적 승인 후 예약을 재개하고 완료 상태까지 확인한 write 동작의 실제 결과입니다."
